                        ...
                        @if ($categories->isNotEmpty())
                            @foreach ($categories as $item)
                                <tr>
                                    ...
                                    <td>
                                        @if($item->image!="")
                                        <img width="50" height="50" src="{{asset('uploads/categories/'.$item->image)}}" alt="">
                                        @endif
                                    </td>
                                    <td>{{ $item->name }}</td>
                                    <td>{{ $item->slug }}</td>
                                    ...
                                    <td align="middle">
                                        ...
                                        <form id="delete-product-from-{{$item->id}}" action="{{route('categories.destroy',$item->id)}}" method="POST">
                                            @csrf
                                            @method('delete')
                                        </form>
                                    </td>
