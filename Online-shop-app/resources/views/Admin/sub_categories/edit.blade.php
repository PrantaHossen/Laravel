                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input readonly type="text" name="slug" id="slug" class="form-control" placeholder="Slug" value="{{ old('slug', $subCategory->slug) }}">
                                @error('slug')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="showHome" required id="showHome" class="form-control">
                                    <option value="Yes" {{ old('showHome', $subCategory->showHome) == 'Yes' ? 'selected' : '' }}>Yes</option>
                                    <option value="No" {{ old('showHome', $subCategory->showHome) == 'No' ? 'selected' : '' }}>No</option>
                                </select>
                                @error('showHome')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
