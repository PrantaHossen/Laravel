                        ...
                        @if ($brands->isNotEmpty())
                            @foreach ($brands as $item)
                                <div class="form-check mb-2">
                                    <input {{ ( in_array( $item->id, $brandsArray)) ? 'checked' : '' }} class="form-check-input brand-label" name="brand[]" type="checkbox" value="{{ $item->id }}"
                                        id="brand-{{ $item->id }}">
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="card product-card">
                                                <div class="product-image position-relative">
                                                    ...
                                                    <a class="whishlist position-absolute top-0 end-0" href="#"><i class="far fa-heart"></i></a>
                                                </div>
                                                <div class="card-body text-center">
                                                    <a class="h6 link d-block mb-1"
                                                        href="{{ route('shop.product', $item->slug) }}">{{ $item->name }}</a>
