...
<head>
    ...
    <title>Laravel Ecommerce Shop</title>
        ...
        <div class="container">
            <div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
                ...
                <div class="col-lg-6 col-6 text-left  d-flex justify-content-end align-items-center">
                    {{-- <a href="{{route('admin.login')}}" class="nav-link text-dark">User Login</a> --}}
                    <a href="{{ route('admin.login') }}" class="nav-link text-dark">User Login</a>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-xl" id="navbar">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-dark">
                                            @foreach ($category->sub_category as $subCategory)
                                                <li><a class="dropdown-item nav-link"
                                                        href="{{ route('shop.index', [$category->slug, $subCategory->slug]) }}">{{ $subCategory->name }}</a>
                                                </li>
                                            @endforeach
                ...
                <div class="right-nav py-0">
                    <a href="{{ route('cart.cart') }}" class="ml-3 d-flex pt-2">
